...
文件见SM3_BirthdayAttack.py文件，参考链接：gitee.com/snowlandltd/snowland-smx-python/（装SM3相关环境）
...
文件见Report on Ethereum with ECDSA文件，参考链接1：zhuanlan.zhihu.com/p/442141489
