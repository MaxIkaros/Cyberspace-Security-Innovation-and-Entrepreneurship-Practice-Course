...
本repo自创建之日起至2022年7月30日晚上11时设置为`Public`状态（由于对github系统的不熟悉），自2022年7月30日晚上11时至2022年7月31日下午3时设置为`Private`状态，自2022年7月31日下午3时至该课程成绩公布之日将设为`Public`状态。

## 一些建议

希望以后开展这门课程的时候，稍微讲述一下如何将repo设置为`Private`状态。

![image-20220731142001294](README/assets/image-20220731142001294.png)

上图的信息来源时间截至2022年7月31日下午2点。
